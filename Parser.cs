...
internal class Parser
{
    ...
    Stmt? Declaration()
    {
        try
        {
            ...
            {
                return new Expression(FunctionDeclaration("function"));
            }
    ...
    private Expr FunctionDeclaration(string kind)
    {
        var anonymous = !Check(TokenType.Identifier);
        
        var name = anonymous ? null : Consume(TokenType.Identifier, $"Expect {kind} name");
